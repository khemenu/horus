...
const (
	AccountService_Create_FullMethodName = "/khepri.horus.AccountService/Create"
	AccountService_Delete_FullMethodName = "/khepri.horus.AccountService/Delete"
	AccountService_Get_FullMethodName    = "/khepri.horus.AccountService/Get"
	AccountService_List_FullMethodName   = "/khepri.horus.AccountService/List"
	AccountService_Update_FullMethodName = "/khepri.horus.AccountService/Update"
)
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "khepri.horus.AccountService",
...
const (
	...
	IdentityService_List_FullMethodName   = "/khepri.horus.IdentityService/List"
	IdentityService_Update_FullMethodName = "/khepri.horus.IdentityService/Update"
)
...
type IdentityServiceClient interface {
	...
	List(ctx context.Context, in *ListIdentityRequest, opts ...grpc.CallOption) (*ListIdentityResponse, error)
...
func (c *identityServiceClient) List(ctx context.Context, in *ListIdentityRequest, opts ...grpc.CallOption) (*ListIdentityResponse, error) {
	out := new(ListIdentityResponse)
	err := c.cc.Invoke(ctx, IdentityService_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IdentityServiceServer interface {
	...
	List(context.Context, *ListIdentityRequest) (*ListIdentityResponse, error)
...
func (UnimplementedIdentityServiceServer) List(context.Context, *ListIdentityRequest) (*ListIdentityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method List not implemented")
}
...
func _IdentityService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdentityServiceServer).List(ctx, req.(*ListIdentityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var IdentityService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "khepri.horus.IdentityService",
...
var InvitationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "khepri.horus.InvitationService",
...
const (
	MembershipService_Create_FullMethodName = "/khepri.horus.MembershipService/Create"
	MembershipService_Delete_FullMethodName = "/khepri.horus.MembershipService/Delete"
	MembershipService_Get_FullMethodName    = "/khepri.horus.MembershipService/Get"
	MembershipService_List_FullMethodName   = "/khepri.horus.MembershipService/List"
	MembershipService_Update_FullMethodName = "/khepri.horus.MembershipService/Update"
)
...
func (c *membershipServiceClient) List(ctx context.Context, in *ListMembershipRequest, opts ...grpc.CallOption) (*ListMembershipResponse, error) {
	out := new(ListMembershipResponse)
	err := c.cc.Invoke(ctx, MembershipService_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMembershipServiceServer) List(context.Context, *ListMembershipRequest) (*ListMembershipResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method List not implemented")
}
...
func _MembershipService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MembershipServiceServer).List(ctx, req.(*ListMembershipRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MembershipService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "khepri.horus.MembershipService",
...
const (
	SiloService_Create_FullMethodName = "/khepri.horus.SiloService/Create"
	SiloService_Delete_FullMethodName = "/khepri.horus.SiloService/Delete"
	SiloService_Get_FullMethodName    = "/khepri.horus.SiloService/Get"
	SiloService_Update_FullMethodName = "/khepri.horus.SiloService/Update"
)
...
var SiloService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "khepri.horus.SiloService",
...
const (
	TeamService_Create_FullMethodName = "/khepri.horus.TeamService/Create"
	TeamService_Delete_FullMethodName = "/khepri.horus.TeamService/Delete"
	TeamService_Get_FullMethodName    = "/khepri.horus.TeamService/Get"
	TeamService_Update_FullMethodName = "/khepri.horus.TeamService/Update"
)
...
var TeamService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "khepri.horus.TeamService",
...
var TokenService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "khepri.horus.TokenService",
...
const (
	UserService_Create_FullMethodName = "/khepri.horus.UserService/Create"
	UserService_Delete_FullMethodName = "/khepri.horus.UserService/Delete"
	UserService_Get_FullMethodName    = "/khepri.horus.UserService/Get"
	UserService_Update_FullMethodName = "/khepri.horus.UserService/Update"
)
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "khepri.horus.UserService",
