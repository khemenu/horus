...
// function as Authorizer mutator.
type AuthorizerFunc func(context.Context, *ent.AuthorizerMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AuthorizerFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AuthorizerMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AuthorizerMutation", m)
}
