...
// AuthorizerOrErr returns the Authorizer value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e UserEdges) AuthorizerOrErr() (*Authorizer, error) {
	if e.loadedTypes[2] {
		if e.Authorizer == nil {
			// Edge was loaded but was not found.
			return nil, &NotFoundError{label: authorizer.Label}
		}
