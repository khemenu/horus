...
func toPbOrg(v *horus.Silo) *pb.Org {
	return &pb.Org{
		Id:    v.Id[:],
		Alias: v.Alias,
		Name:  v.Name,
...
func fromPbOrg(v *pb.Org) *horus.Silo {
	if v == nil {
		return nil
	}

	return &horus.Silo{
		Id:   horus.SiloId(v.Id),
		Name: v.Name,
	}
}
...
func (s *grpcServer) NewOrg(ctx context.Context, req *pb.NewOrgReq) (*pb.NewOrgRes, error) {
	...
	rst, err := s.Horus.Orgs().New(ctx, horus.SiloInit{OwnerId: user.Id})
	if err != nil {
...
func (s *grpcServer) UpdateOrg(ctx context.Context, req *pb.UpdateOrgReq) (*pb.UpdateOrgRes, error) {
	...
	member, err := s.Horus.Members().GetByUserIdFromOrg(ctx, horus.SiloId(org_id), user.Id)
	if err != nil {
...
func (s *grpcServer) InviteUser(ctx context.Context, req *pb.InviteUserReq) (*pb.InviteUserRes, error) {
	...
	member, err := s.Members().GetByUserIdFromOrg(ctx, horus.SiloId(org_id), user.Id)
	if err != nil {
...
func (s *grpcServer) LeaveOrg(ctx context.Context, req *pb.LeaveOrgReq) (*pb.LeaveOrgRes, error) {
	...
	err = s.Members().DeleteByUserIdFromOrg(ctx, horus.SiloId(org_id), user.Id)
	if err != nil {
...
func (s *grpcServer) SetRoleOrg(ctx context.Context, req *pb.SetRoleOrgReq) (*pb.SetRoleOrgRes, error) {
	...
	member, err := s.Members().GetById(ctx, horus.AccountId(member_id))
	if err != nil {
		if errors.Is(err, horus.ErrNotExist) {
	...
	me, err := s.Members().GetByUserIdFromOrg(ctx, member.SiloId, user.Id)
	if err != nil {
		if errors.Is(err, horus.ErrNotExist) {
...
func (s *grpcServer) DeleteOrgMember(ctx context.Context, req *pb.DeleteOrgMemberReq) (*pb.DeleteOrgMemberRes, error) {
	...
	member, err := s.Members().GetByUserIdFromOrg(ctx, target_member.SiloId, user.Id)
	if err != nil {
		if errors.Is(err, horus.ErrNotExist) {
			return &pb.DeleteOrgMemberRes{}, nil
		}
