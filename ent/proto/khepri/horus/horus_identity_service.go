...
func toProtoIdentity(e *ent.Identity) (*Identity, error) {
	v := &Identity{}
...
func (svc *IdentityService) Create(ctx context.Context, req *CreateIdentityRequest) (*Identity, error) {
...
func (svc *IdentityService) Get(ctx context.Context, req *GetIdentityRequest) (*Identity, error) {
	var (
		err error
		get *ent.Identity
	)
	id := req.GetId()
	switch req.GetView() {
	case GetIdentityRequest_VIEW_UNSPECIFIED, GetIdentityRequest_BASIC:
		get, err = svc.client.Identity.Get(ctx, id)
	case GetIdentityRequest_WITH_EDGE_IDS:
...
func (svc *IdentityService) Update(ctx context.Context, req *UpdateIdentityRequest) (*Identity, error) {
	identity := req.GetIdentity()
...
func (svc *IdentityService) Delete(ctx context.Context, req *DeleteIdentityRequest) (*emptypb.Empty, error) {
	var err error
	id := req.GetId()
...
func (svc *IdentityService) createBuilder(identity *Identity) (*ent.IdentityCreate, error) {
