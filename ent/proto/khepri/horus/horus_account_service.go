...
func toProtoAccount_Role(e account.Role) Account_Role {
	if v, ok := Account_Role_value[strings.ToUpper("ROLE_"+protoIdentNormalizeAccount_Role(string(e)))]; ok {
		return Account_Role(v)
	}
	return Account_Role(0)
}

func toEntAccount_Role(e Account_Role) account.Role {
	if v, ok := Account_Role_name[int32(e)]; ok {
